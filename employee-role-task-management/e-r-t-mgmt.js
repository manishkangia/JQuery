var employees = [{"name":"akhil","search":"0"},{"name":"hk","search":"0"},{"name":"rd","search":"0"},{"name":"alok","search":"0"},{"name":"kashish","search":"0"},{"name":"ashish","search":"0"},{"name":"jatin","search":"0"},{"name":"kapil","search":"0"}];
var roles = [{"id":"0","name":"ROR Developer"},{"id":"1","name":"JS/JQuery"},{"id":"2","name":"Android"},]
$( function() {
    ...
    function fillEmployees() {
        ...
        $.each(employees, function(i, item) {
            var emploDiv = $("<div class='employee"+((i%2 == 0)? 0 : 1)+"'></div>");
            var p = $('<p draggable=true>' + item["name"] + '</p>'); 
            var image = $('<img class=delete src=delete.png></img>');
    ...
    $.each(roles, function(i, item) {
        ...
        function appendAssignedToDo( assignedTask, employee, roleName, toDoIndex ) {
            ...
            var imageIconDelete = $("<img src='delete.png'></img>");
    ...
    $('#searchdiv input:button').click(function() {
        var toDoNumber = parseInt($(this).siblings('input:text').val());
        $.each(employees,function(index, employee) {
